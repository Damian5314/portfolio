      ...
      experience: [
        {
          ...
          description: 'Ontwikkeling van moderne webapplicaties met React en Python.',
        },
        {
          role: 'Sales Medewerker',
          company: 'MediaMarkt',
          period: '2021 - 2024',
          description: 'Klantenservice en technische ondersteuning voor electronica.',
        },
        {
          role: 'Medewerker',
          company: 'Dirk van den Broek',
          period: '2019 - 2021',
          description: 'Klantgerichte service en teamwork in retail omgeving.',
        },
      ],
